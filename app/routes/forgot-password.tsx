...
async function sendPasswordResetEmail({
	...
	await sendEmail({
		to: user.email,
		subject: `REPLACE_WITH_APP_NAME Password Reset`,
		...
		<html>
			...
			<body>
				<h1>Reset your REPLACE_WITH_APP_NAME password.</h1>
				<p>Click the link below to reset the REPLACE_WITH_APP_NAME password for ${user.username}.</p>
...
export const meta: V2_MetaFunction = ({ matches }) => {
	...
	return [
		...
		{ title: 'Password Recovery for REPLACE_WITH_APP_NAME' },
	]
}
